class CreateCountryTable < ActiveRecord::Migration
  def self.up  
    ...
    Country.create(:iso => 'BL', :name => 'SAINT BARTHELEMY', :printable_name => 'Saint Barthélemy', :iso3 => 'BLM', :numcode => '652')  
    ...
    Country.create(:iso => 'BL', :name => 'SAINT BARTHELEMY', :printable_name => 'Saint Barthélemy', :iso3 => 'BLM', :numcode => '590')
    ...
    Country.create(:iso => 'MF', :name => 'SAINT MARTEEN', :printable_name => 'Saint Marteen', :iso3 => 'MAF', :numcode => '1599')
